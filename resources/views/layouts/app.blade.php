...
<head>
    <meta charset="utf-8" />
    <title>@yield('title', 'Night Bird')</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta content="" name="keywords" />
    <meta content="" name="description" />
    <link rel="icon" type="image/png" href="{{ asset('img/hero4.png') }}">
            ...
            <nav class="navbar navbar-light navbar-expand-lg py-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a href="{{route('menu')}}"
                            class="nav-item nav-link {{request()->is('menu') ? 'active' : ''}}">Our collection</a>
        ...
        <div class=" row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    <h1 class="text-primary">
                        Night<span class="text-dark">Bird</span>
                    </h1>
                    <p class="lh-lg mb-4">
                        Experience the Pure Comfort & Authentic Styles
            ...
            <div class="col-lg-2 col-md-6">
                <div class="footer-item">
                    ...
                    <div class="d-flex flex-column align-items-start">
                        <a class="text-body mb-3" href="#"><i class="fa fa-check text-primary me-2"></i>Mens</a>
                        <a class="text-body mb-3" href="#"><i class="fa fa-check text-primary me-2"></i>Womens</a>
                        <a class="text-body mb-3" href="#"><i class="fa fa-check text-primary me-2"></i>Kids</a>
                        <a class="text-body mb-3" href="#"><i class="fa fa-check text-primary me-2"></i>Accessories</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-6">
                <div class="footer-item">
                    ...
                    <p style="font-size:15px;"> <i class="fa fa-map-marker-alt text-primary me-2"></i> Maktha
                        Mahaboobpet,
                        Seri Lingampally Municipality,
                        RR District, Hyderabad,
                        Telangana 500049
                    </p>
                    <p><i class="fas fa-phone text-primary me-2"></i> (+91) 95318 89591</p>
            ...
            <div class="col-lg-2 col-md-6">
                <div class="footer-item">
                    ...
                    <div class="row g-2">
                        <div class="col-4"><img src="{{ asset('img/gallery1.jpg') }}"
                                class="img-fluid rounded-circle border border-primary p-2" alt="dish thumbnail"></div>
                        <div class="col-4"><img src="{{ asset('img/gallery2.jpg') }}"
                                class="img-fluid rounded-circle border border-primary p-2" alt="dish thumbnail"></div>
                        <div class="col-4"><img src="{{ asset('img/gallery3.jpg') }}"
                                class="img-fluid rounded-circle border border-primary p-2" alt="dish thumbnail"></div>
                        <div class="col-4"><img src="{{ asset('img/gallery4.jpg') }}"
                                class="img-fluid rounded-circle border border-primary p-2" alt="dish thumbnail"></div>
                        <div class="col-4"><img src="{{ asset('img/gallery5.jpg') }}"
                                class="img-fluid rounded-circle border border-primary p-2" alt="dish thumbnail"></div>
                        <div class="col-4"><img src="{{ asset('img/gallery6.jpg') }}"
                                class="img-fluid rounded-circle border border-primary p-2" alt="dish thumbnail"></div>
                    </div>
                </div>
            </div>
