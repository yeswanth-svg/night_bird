    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Dress Details</h3>
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.dishes.index') }}">Dress Details</a>
                    </li>
                    <li class="separator">
                        <i class="icon-arrow-right"></i>
                    </li>
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="card shadow border-0">
                        <div class="card-header text-white">
                            <h4 class="card-title fw-bold text-primary"><i class="fas fa-info-circle"></i>Dress Details
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label class="fs-5 fw-bold text-primary">Dress Name</label>
                                    <p class="text-dark border rounded px-3 py-2">{{ $dish->name }}</p>
                                </div>
                                <div class="col-md-6">
                                    <label class="fs-5 fw-bold text-primary">Category</label>
                                    <p class="text-dark border rounded px-3 py-2">{{ $dish->type->name }}</p>
                                </div>
                            </div>
                        ...
                        {{ $dish->availability_status == 'in_stock' ? 'bg-success' : 'bg-danger' }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label class="fs-5 fw-bold text-primary">Dress Image</label>
